...
-   **NEW: Arduino LVGL Low-Code GUI Builder** - Import existing Arduino LVGL projects, edit them visually, and export back to C++ code. Perfect for FilaGauge and other Arduino-based LVGL projects. [Read more](docs/ARDUINO_LVGL_BUILDER.md)
